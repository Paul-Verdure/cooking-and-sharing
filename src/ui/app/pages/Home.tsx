...
function Home() {
	return (
		<>
			<section className="flex max-h-[600px] items-center justify-center space-x-8 px-8">
				<div className="flex-column space-y-6">
					...
					<div className="space-x-4">
						...
						<button className="text-wistful-600 border-wistful-600 active:bg-wistful-200 hover: hover:bg-wistful-100 rounded border-2 px-4 py-2 font-bold">
							Sign Up
						</button>
					</div>
				</div>
				<div>
					<img src={home} alt="home" className="max-h-[800px]" />
				</div>
			</section>
			<section className="bg-wistful-200 flex max-h-[600px] items-center space-x-8 px-8">
				<div>
					<img src={cooking} alt="cooking" className="max-h-[800px]" />
				</div>
				<div className="flex-column space-y-6">
